...
#### Tag and Topics
- Enhancement - Tag and Topics filter ‘contains’ are not alphabetical 

### Card

- when selecting the iPad view on a smaller screen, it overlays with the Card information fields on the right.
