...
- [AI Content Manager User Guide](#ai-content-manager-user-guide)
  ...
  - [Accessing the Content Manager](#accessing-the-content-manager)
  - [Content Manager Interface](#content-manager-interface)
  - [Content Selection](#content-selection)
    - [Selected Content View](#selected-content-view)
    - [Managing Selected Content](#managing-selected-content)
  - [Knowledge Base Selection](#knowledge-base-selection)
    - [Browsing Knowledge Bases](#browsing-knowledge-bases)
    - [Selecting Knowledge Bases](#selecting-knowledge-bases)
  - [Individual Content Selection](#individual-content-selection)
    - [Browsing Content Items](#browsing-content-items)
    - [Selecting Specific Content Items](#selecting-specific-content-items)
