...
Based on Sairis' licensing documentation, here's a comprehensive comparison between Discover and Generate users: 

| Control/Capability/Feature                          | Discover License ($35/month)                          | Generate License ($99/month)                          |
|-----------------------------------------------------|-------------------------------------------------------|-------------------------------------------------------|
| **Included Credits**                                | 1 AI Credit/Mo                                        | 20 AI Credits/Mo                                      |
| **Target Users**                                    | Deskless end users and frontline employees            | Desked knowledge workers                              |
...
| **Process Automation**                              | ✓ Multi-step workflow capabilities                    | ✓ Control multi-step reasoning                        |
| **Launchpad Capabilities**                          | ✓ Personalized workspace                              | ✓ Personalized workspace                              |
| **My Content (Personal File Management)**           | ✗ Cannot upload or manage                             | ✓ Full personal workspace with search                 |
| **File Attachments to Conversations**               | ✗ Cannot attach files                                 | ✓ Full attachment capabilities                        |
| **LLM Selection Control**                           | ✗ No control                                          | ✓ Switch between providers                            |
| **Turn-by-Turn AI Controls**                        | ✗ Not available                                       | ✓ Granular per-turn settings                          |
